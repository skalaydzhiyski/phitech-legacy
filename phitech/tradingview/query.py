...
from phitech.tradingview.scanner import get_scanner_data, COLUMNS
...
class QueryDict(TypedDict):
    """
    The fields are the best part brother
    """
...
class Column:
    """
    A Column object represents a field in the tradingview stock scanner,
...
class Query:
    """
    This class allows you to perform SQL-like queries on the tradingview stock-scanner.
